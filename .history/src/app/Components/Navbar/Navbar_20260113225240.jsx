...
<nav class="bg-white w-full fixed shadow-lg">
  <div class="max-w-7xl mx-auto px py-4 flex items-center justify-between">

    {/* <!-- LOGO --> */}
    <div class="flex items-center gap-2 h-full bg-green-700  w-xs">
      <span class="text-3xl font-bold text-green-700">Frutin</span>
    </div>
